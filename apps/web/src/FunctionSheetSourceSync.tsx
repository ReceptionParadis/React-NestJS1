...
function relevant(groups:Group[],sheet:WeeklySheet){return groups.filter(g=>g.commercialValidated&&String(g.arrival||'')<=sheet.weekEnd&&String(g.departure||'')>=sheet.weekStart).sort((a,b)=>String(a.id).localeCompare(String(b.id)))}
