...
const coreModules=[
 ...
 {title:'Feuille de route veilleur',description:'Consulter les informations utiles de nuit alimentées par le Contrôle Groupe.',href:'/reception/feuille-route-veilleur',icon:MoonStar},
];
