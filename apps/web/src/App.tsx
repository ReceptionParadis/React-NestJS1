...
import {
  BookOpenCheck, BriefcaseBusiness, CalendarDays, ClipboardList, ConciergeBell,
  History, LayoutDashboard, ListTodo, Menu, RefreshCw, Settings, Sparkles,
  Stethoscope, UtensilsCrossed, Wrench, X,
} from 'lucide-react';
