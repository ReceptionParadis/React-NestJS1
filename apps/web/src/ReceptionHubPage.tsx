import { ArrowLeft, Calculator, ClipboardCheck, FileArchive, FileText, MessageSquareWarning, MoonStar } from 'lucide-react';
...
export function ReceptionHubPage(){
 ...
 const cards=[
  ...
  {title:'Feuille de route veilleur',description:'Repas et effectifs de nuit alimentés par le Contrôle Groupe.',href:'/reception/feuille-route-veilleur',icon:MoonStar},
