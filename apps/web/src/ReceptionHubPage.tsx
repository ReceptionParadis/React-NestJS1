import { ArrowLeft, BellRing, CalendarDays, ClipboardCheck, FileArchive, FileText, MoonStar, UsersRound } from 'lucide-react';
...
export function ReceptionHubPage(){
 ...
 const requests=useOperationalStore<IndividualRequest[]>('individual-requests',[]);
 ...
 const activeRequests=requests.data.filter(r=>r.status!=='Terminée').length;
 const cards=[
  ...
  {title:'Demandes clients individuels',description:'Enregistrer les taxis, réveils, PDJ Box et paniers repas avec chambre, horaire et consignes.',href:'/reception/demandes-individuelles',icon:BellRing,count:activeRequests,label:'demande(s) active(s)'},
  {title:'Feuille de route veilleur',description:'Consolider automatiquement les événements de 22h00 à 08h30 et imprimer la feuille de nuit en A4 portrait.',href:'/reception/feuille-route-veilleur',icon:MoonStar,count:0,label:'feuille de nuit'},
