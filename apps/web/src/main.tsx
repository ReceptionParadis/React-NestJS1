...
const receptionGroupsRoute = path.startsWith('/reception/groupes');
const commercialGroupsRoute = path.startsWith('/commercial/groupes') || path === '/groupes' || path.startsWith('/groupes?');
const groupsRoute = receptionGroupsRoute || commercialGroupsRoute;
