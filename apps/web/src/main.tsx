...
function RouteScopedBridges(){if(dashboardRoute)return <><OperationalToastHost/><UserAccountMenu/><DirectionReportsNav/><ReceptionComplaintsNav/><DashboardNativeConsistencyBridge/></>;if(cashRoute)return <><DirectionCashUnlockBridge/><CashValidatedBannerScopeBridge/><OperationalPrintRecovery/><OperationalToastHost/><UserAccountMenu/><DirectionReportsNav/><ReceptionComplaintsNav/></>;return <><OperationalToastHost/><UserAccountMenu/><DirectionReportsNav/><UnifiedNotificationHost/><CommandCenterButton/>{receptionRoute&&<><ReceptionMealNav/><ReceptionComplaintsNav/></>}{controlsRoute&&<><GroupControlCompletionRecovery/><GroupControlPrintRecovery/><GroupControlUnlockPermissionBridge/></>}{groupsRoute&&<><Group360PendingInfoHelper/><Group360DeleteAction/><GroupCreateExperience/></>}{archivesRoute&&<><Group360ArchiveFilter/><OperationalArchiveAdditions/><GroupControlReprintArchive/></>}{functionSheetRoute&&<><FunctionSheetSourceSync/><FunctionSheetPrintCleanup/><FunctionSheetPrintBridge/></>}{nightRoute&&<NightRouteGroupRequestsBridge/>}{complaintsRoute&&<ComplaintsPrintBridge/>}{mealRoute&&<><MealOrderAutoSync/><MealOrdersPrintBridge/><PdjBoxMealRow/></>}{adminRoute&&<AdministrationRoleProfileBridge/>}{maintenanceRoute&&<MaintenanceExperienceBridge/>}{path.startsWith('/menage')&&<HousekeepingTypeDisplayBridge/>}{(nightRoute||complaintsRoute)&&<OperationalPrintRecovery/>}</>}
