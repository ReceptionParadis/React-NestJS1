...
export function NightAuditorNav(){
 ...
 return createPortal(<div className="night-auditor-nav"><div className="nav-item night-auditor-title"><MoonStar size={18}/><span>Veilleur de nuit</span></div>{item('/reception/plaintes','Plaintes',MessageSquareWarning)}{item('/reception/feuille-route-veilleur','Feuille de route veilleur',History)}</div>,host);
}
